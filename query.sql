...
LEFT JOIN RESERVATION R
    ON V.Enrollment = R.VEHICLE
WHERE '2021-04-11' NOT BETWEEN R.STARDATE AND R.ENDINGDATE
    AND '2021-04-15' NOT BETWEEN R.STARDATE AND R.ENDINGDATE
    OR R.STARDATE IS NULL;